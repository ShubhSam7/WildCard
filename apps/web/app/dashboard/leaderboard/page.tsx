    ...
    <DashboardLayout rightPanel={<RightPanel />}>
      <div className="mb-8">
        ...
        <p className="body-lg text-on-variant max-w-2xl">
          Top forecasters ranked by WildCoins balance.
        </p>
      </div>
...
function TopUserCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="title-lg text-on-surface mb-4">
        {user.name || "Anonymous"}
      </h3>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <p className="title-sm font-bold text-secondary">
            {formatWildCoins(user.wild_coins)}
          </p>
        </div>
      </div>
    </Card>
