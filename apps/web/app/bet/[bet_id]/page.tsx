...
const MOCK_MARKET = {
  ...
  resolutionCriteria: "This market will resolve to YES if a human being physically sets foot on the surface of Mars before 11:59 PM UTC on December 31, 2029. The landing must be confirmed by at least two independent space agencies or reputable news organizations. A flyby, orbital mission, or robotic landing does not count.",
};
