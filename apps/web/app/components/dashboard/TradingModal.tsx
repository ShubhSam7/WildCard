...
export function TradingModal({ isOpen, onClose, market }: TradingModalProps) {
  ...
  const handleAmountChange = (value: string) => {
    ...
    if (num > 0 && !isValidBetAmount(num)) {
      setValidationError(
        `Amount must be a multiple of ${MIN_BET_AMOUNT} WildCoins`,
      );
    } else {
      setValidationError("");
    }
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-6 pointer-events-none">
        ...
        >
          ...
          {/* Trade Input */}
          <div className="mb-4">
            <label className="label-sm text-on-variant mb-2 block">
              BET AMOUNT (WildCoins)
            </label>
            <input
              type="number"
            ...
            />
            <p className="text-xs text-on-variant mt-1">
              Bet in multiples of {MIN_BET_AMOUNT} WildCoins
            </p>
            {validationError && (
          ...
          <div className="bg-surface-high p-4 rounded-lg mb-4 space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="body-md text-on-surface font-medium">{shares}</p>
            </div>
          ...
          <div className="mb-6 text-center">
            <p className="body-sm text-on-variant">
              ...
              {formatWildCoins(shares > 0 ? shares - cost : 0)}
            </p>
          </div>
            ...
            <div className="bg-surface-low rounded-lg p-4 max-h-48 overflow-y-auto space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-on-variant mt-1">
                    I think YES has strong fundamentals. The market indicators
                    are pointing upward.
                  </p>
                  <p className="text-xs text-on-variant opacity-60 mt-1">
                    2 hours ago
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-on-variant mt-1">
                    Not sure about this one. Historical data suggests otherwise.
                  </p>
                  <p className="text-xs text-on-variant opacity-60 mt-1">
                    5 hours ago
                  </p>
