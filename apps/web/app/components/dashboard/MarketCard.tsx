    ...
    <Link href={`/bet/${id}`} className="block group">
        ...
        <CardHeader className="pb-2 px-3 pt-3">
          <div className="flex items-start justify-between gap-2 mb-1.5">
            ...
            {trending && (
              <Badge variant="tertiary" size="sm" className="flex items-center gap-1 text-xs py-0.5 px-2">
        ...
        <CardContent className="pb-2 px-3">
          ...
          <div className="mb-2">
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-medium text-secondary">YES {yesPrice}%</span>
              <span className="text-xs font-medium text-error">NO {noPrice}%</span>
            </div>
