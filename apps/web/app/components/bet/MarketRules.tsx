...
export function MarketRules({ resolutionCriteria, volume24h, liquidity }: MarketRulesProps) {
  return (
    <GlassPanel blur="normal" className="p-6">
      ...
      {/* Resolution Criteria */}
      <div className="mb-6">
        <h3 className="text-sm font-medium text-on-variant mb-2">Resolution Criteria:</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-lg font-semibold text-on-surface">{volume24h}</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-lg font-semibold text-on-surface">{liquidity}</div>
            </div>
          </div>
        </div>
      </div>
