  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-2xl font-bold text-on-surface">MARKET DISCUSSION</h2>
      ...
      <div className="space-y-4">
        {comments.map((comment) => (
          <CommentCard key={comment.id} comment={comment} getBadgeVariant={getBadgeVariant} />
        ))}
      </div>
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            {comment.badge && (
              <Badge variant={getBadgeVariant(comment.badge) as any} size="sm" className="text-xs">
                {comment.badge}
              </Badge>
            )}
            <span className="text-xs text-on-variant ml-auto">{comment.time}</span>
          </div>
        </div>
      </div>
